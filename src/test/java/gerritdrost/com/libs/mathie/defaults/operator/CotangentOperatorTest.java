...
public class CotangentOperatorTest {
	...
	public void setup() {
		mathieEnv = new ExpressionEnvironment(new DefaultConfiguration() {
			...
			public Collection<Operator> getOrderedOperators() {
				return Arrays.asList(new Operator[] { new CosecantOperator(), new MultiplyOperator(), new VariableOperator(),
														new ValueOperator() });
			}
	...
	public void checkDefault() {
		assertEquals(1.0, mathieEnv.getExpression("csc(0.5*pi)")
									.getValue(), DELTA);
	}
