...
public class SecantOperatorTest {
	...
	public void setup() {
		mathieEnv = new ExpressionEnvironment(new DefaultConfiguration() {
			...
			public Collection<Operator> getOrderedOperators() {
				return Arrays.asList(new Operator[] { new SecantOperator(), new VariableOperator(),
														new ValueOperator() });
			}
	...
	public void checkDefault() {
		assertEquals(-1.0, mathieEnv.getExpression("sec(pi)")
									.getValue(), DELTA);
	}
